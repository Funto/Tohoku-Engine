...
// ---------------------------------------------------------------------
TextureReducer::TextureReducer(uint target_width, uint target_height)
...
TextureReducer::~TextureReducer()
{
}

// ---------------------------------------------------------------------
void TextureReducer::setup()
{
	createProgram();
	createVBOAndVAO();
}

void TextureReducer::cleanup()
{
	assert(program != NULL);
	delete program;
	program = NULL;
...
// ---------------------------------------------------------------------
void TextureReducer::run(GLRaytracer* gl_raytracer, uint offset_x)
{
	uint texunit = 0;
...
// ---------------------------------------------------------------------
void TextureReducer::createProgram()
{
	stringstream ss;
	bool ok = false;
...
// ---------------------------------------------------------------------
void TextureReducer::createVBOAndVAO()
{
	// Create the VAO:
